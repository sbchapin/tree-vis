...
class RelationshipsControllerTest < ActionController::TestCase
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post :create, relationship: { entity_source_id: @relationship.entity_source_id, entity_target_id: @relationship.entity_target_id }
    end
  ...
  test "should update relationship" do
    patch :update, id: @relationship, relationship: { entity_source_id: @relationship.entity_source_id, entity_target_id: @relationship.entity_target_id }
    assert_redirected_to relationship_path(assigns(:relationship))
  end
